...
namespace Funkmap.Controllers
{
    ...
    public class BandController: ApiController
    {
        ...
        public async Task<IHttpActionResult> GetInviteMusicianInfo(BandInviteInfoRequest request)
        {
            ...
            var availableBands = bandEntities.Cast<BandEntity>().Where(x=>!x.InvitedMusicians.Contains(request.InvitedMusician) && !x.MusicianLogins.Contains(request.InvitedMusician))
