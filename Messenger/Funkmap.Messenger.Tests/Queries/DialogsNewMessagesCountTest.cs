...
namespace Funkmap.Messenger.Tests.Queries
{
    public class DialogsNewMessagesCountTest
    {
        ...
        public DialogsNewMessagesCountTest()
        {
        ...
        public void GetDialogsNewMessagesCount()
        {
            ...
            Assert.NotEqual(result.CountResults.Count, 0);
            ...
            Assert.Equal(allMessages.Where(x => x.IsNew).GroupBy(x => x.DialogId).Count(), result.CountResults.Count);
        }
    }
}
